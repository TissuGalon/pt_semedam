...
const erpModules = [
  {
    ...
    icon: BookOpen,
    color: 'border-t-orange-500 hover:border-orange-600',
  ...
  },
  {
    ...
    icon: Boxes,
    color: 'border-t-blue-500 hover:border-blue-600',
  ...
  },
  {
    ...
    href: '/portal/assets',
    icon: Building2,
    color: 'border-t-sky-500 hover:border-sky-600',
  ...
  },
  {
    ...
    href: '/portal/kas-bank',
    icon: Wallet,
    color: 'border-t-indigo-500 hover:border-indigo-600',
  ...
  },
  {
    ...
    href: '/portal/payroll',
    icon: Users,
    color: 'border-t-emerald-500 hover:border-emerald-600',
